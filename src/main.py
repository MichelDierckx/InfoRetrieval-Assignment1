...
# Expected rankings filenames
DEV_QUERIES_EXPECTED_RESULT = "dev_query_results.csv"
DEV_QUERIES_EXPECTED_RESULT_SMALL = "dev_query_results_small.csv"
...
def main():
    ...
    if DEV:
        if SIZE == "SMALL":
            ...
            queries_expected = f'{DIRECTORY_RANKINGS}/{DEV_QUERIES_EXPECTED_RESULT_SMALL}'
        elif SIZE == "FULL":
            ...
            queries_expected = f'{DIRECTORY_RANKINGS}/{DEV_QUERIES_EXPECTED_RESULT}'
        else:
    ...
    if DEV:
        evaluate(queries_ranking, queries_expected, k)
    # Stop profiling
    profiler.disable()
